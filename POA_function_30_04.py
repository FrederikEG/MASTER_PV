# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 09:32:48 2024
...
#%%%
    ...
    fuel_in_front_shadow = (((poa_infinite_sheds['poa_front_direct']*eta_shadow*iam_front+poa_infinite_sheds['poa_front_ground_diffuse']*iam_diffuse_front['ground']+poa_infinite_sheds['poa_front_sky_diffuse']*iam_diffuse_front['sky']))*spec_loss)
    fuel_in_back_shadow = ((poa_infinite_sheds['poa_back_direct']*iam_back+poa_infinite_sheds['poa_back_ground_diffuse']*iam_diffuse_back['ground']+poa_infinite_sheds['poa_back_sky_diffuse']*iam_diffuse_back['sky']))*spec_loss
    ...
    POA_dict['POA fuel_in shadow front'] = fuel_in_front_shadow
    POA_dict['POA fuel_in shadow back'] = fuel_in_back_shadow
...
#%%%
    ...
    shadow_dict = shadow(PV_data, installation_data, tz, data)
    eta_shadow = shadow_dict['eta_shadow']
    fuel_in_front_shadow = (((poa_no_shadow_front['poa_direct']*eta_shadow*iam_front+poa_no_shadow_front['poa_ground_diffuse']*iam_diffuse_front['ground']+poa_no_shadow_front['poa_sky_diffuse']*iam_diffuse_front['sky']))*spec_loss)
    fuel_in_back_shadow = ((poa_no_shadow_back['poa_direct']*iam_back+poa_no_shadow_back['poa_ground_diffuse']*iam_diffuse_back['ground']+poa_no_shadow_back['poa_sky_diffuse']*iam_diffuse_back['sky']))*spec_loss
    poa_front_shadow = poa_no_shadow_front['poa_direct']*eta_shadow + poa_no_shadow_front['poa_diffuse'] + poa_no_shadow_front['poa_ground_diffuse'] + poa_no_shadow_front['poa_sky_diffuse']
    poa_back_shadow = poa_no_shadow_back['poa_direct'] + poa_no_shadow_back['poa_diffuse'] + poa_no_shadow_back['poa_ground_diffuse'] + poa_no_shadow_back['poa_sky_diffuse']  
    poa_global_shadow = poa_front_shadow + poa_back_shadow
    ...
    POA_simple_dict['POA fuel_in shadow front'] = fuel_in_front_shadow
    POA_simple_dict['POA fuel_in shadow back'] = fuel_in_back_shadow
